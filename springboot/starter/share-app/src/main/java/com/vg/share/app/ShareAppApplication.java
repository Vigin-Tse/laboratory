...
@SpringBootApplication //第二种加载非默认包下组件方式 自动配置 扫描包中spring.factories文件（@SpringBootApplication -> @EnableAutoConfiguration -> @Import({AutoConfigurationImportSelector.class})）
