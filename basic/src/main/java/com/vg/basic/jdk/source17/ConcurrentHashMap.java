...
package com.vg.basic.jdk.source17;
...
public class ConcurrentHashMap<K, V> extends AbstractMap<K, V>
    ...
    /** segments 中每个元素都是一个专用的hashtable，并发级别就是hashtable的个数
    ...
    public ConcurrentHashMap(int initialCapacity,
        ...
        if (concurrencyLevel > MAX_SEGMENTS) //concurrencyLevel 实际上就是最大并发数
    ...
    public V put(K key, V value) {
        ...
        int j = (hash >>> segmentShift) & segmentMask; //计算下标
